...
var current_marker: DialogueMarker2D = null
...
func apply_dialogue_line() -> void:
	...
	current_marker = DialogueMarker2D.find_for_character(dialogue_line.character)
	...
	# Give the containers a frame to calculate the bubble's size
...
func _position_balloon() -> void:
	...
	var marker_position := current_marker.get_position_in_viewport()
	
	speech_bubble.position = marker_position - Vector2(
		speech_bubble.size.x / 2.0,
		speech_bubble.size.y + 20.0
	)
